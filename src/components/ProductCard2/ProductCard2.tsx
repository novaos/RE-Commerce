...
export default function ProductCard2({ product, large = false }: { product: ProductType; large?: boolean }) {
  ...
  return (
    <div
      ...
      className={`relative group w-60 h-72 overflow-hidden bg-slate-100 rounded-md hover:shadow-lg duration-150 hover:text-slate-900
        ${large && 'w-80 h-80'}`}>
